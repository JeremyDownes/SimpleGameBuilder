...
,					{description: {type: 'water', interact: {attribute: {wet: 30} , remove: false},imgSrc: require('../resources/images/obstacles/water.png')}, imgSrc: '../resources/images/obstacles/water.png', cursor:'waterCursor'}
